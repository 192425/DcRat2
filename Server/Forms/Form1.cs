...
namespace Server
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void StartToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            try
            {
                string title = Interaction.InputBox("Alert when process is active.", "Title", "Chrome,Edge,Word,Excel,PowerPoint,Epic,Steam");
        ...
        private void listenersToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (FormPorts form = new FormPorts())
            {
                form.ShowDialog();
                if (Application.StartupPath.Contains("52pojie"))
                    AboutToolStripMenuItem.Visible = false;
