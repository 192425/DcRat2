...
namespace Server.Algorithm
{
    public class Aes256
    {
        ...
        //Want to change this to change the sig but it breaks and wont call back if you change this 
        //private static readonly byte[] Salt = Encoding.ASCII.GetBytes("DcRatByqwqdanchun");
        private static readonly byte[] Salt = Encoding.ASCII.GetBytes("Q3JlYXRlZEJ5aWNlLXd6bC4u");
